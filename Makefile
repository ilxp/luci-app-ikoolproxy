...
PKG_VERSION:=3.8.5
PKG_RELEASE:=20211204

include $(INCLUDE_DIR)/package.mk

define Package/luci-app-ikoolproxy
	SECTION:=luci
	CATEGORY:=LuCI
...
define Package/luci-app-ikoolproxy/conffiles
	/etc/config/koolproxy
	/usr/share/koolproxy/data/rules/
endef

define Package/luci-app-ikoolproxy/install
...
$(eval $(call BuildPackage,luci-app-ikoolproxy))
